<%-- 
    Document   : ActivateStudents
    Created on : Nov 7, 2017, 7:04:56 PM
                ...
                <div class="container">
                    ...
                    <table class="table table-bordered">
                        ...
                        <%
                            ...
                            Criteria studentcriteria = session1.createCriteria(pojos.Student.class);
                            studentcriteria.add(Restrictions.eq("state", "inactive"));
                        ...
                        %>
                        <form action="ativatestudents" method="post">
                            <input type="hidden" name="stuid" value="<%= student.getIdstudent()%>">
                            <tr>
                                ...
                                <td><input type="submit" value="Activate" class="btn btn-success"></td>
                            </tr>
                        </form>
