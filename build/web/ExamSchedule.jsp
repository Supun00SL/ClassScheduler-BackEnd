<%-- 
    ...
    Created on : Nov 10, 2017, 2:40:31 PM
...
<html>
    <head>
        ...
        <title>Schedule Examinations</title>
                ...
                <div class="container">
                    ...
                    <div class="form-group col-md-12">
                        <div class="col-md-6">
                            ...
                            <hr>
                            <form method="post" action="sheduleexams">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="submit" value="Shedule Exams" class="btn btn-success">
