 ...
 */
@WebServlet(name = "popoverexam", urlPatterns = {"/popoverexam"})
public class popoverexam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (StudentHasSubjectvisebatch studentHasSubjectvisebatch : hasSubjectvisebatchs) {
                ...
                examCriteria.addOrder(Order.asc("starttime"));
                ...
                if (!examvivashedules.isEmpty()) {
                    for (Examvivashedule examvivashedule : examvivashedules) {
                        ...
                        jSONObject.put("type", examvivashedule.getType());
                        jSONObject.put("time", " Start :" + new SimpleDateFormat("HH:mm").format(examvivashedule.getStarttime()) + " End :" + new SimpleDateFormat("HH:mm").format(examvivashedule.getEndtime()));
                        ...
                        jSONObject.put("location", examvivashedule.getLocation());
                        jSONObject.put("lecturehall", examvivashedule.getLecturehall().getLecturehallnumber());
