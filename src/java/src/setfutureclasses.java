 ...
 */
@WebServlet(name = "setfutureclasses", urlPatterns = {"/setfutureclasses"})
public class setfutureclasses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (StudentHasSubjectvisebatch studentHasSubjectvisebatch : hasSubjectvisebatchs) {
                ...
                classCriteria.add(Restrictions.ge("date", new SimpleDateFormat("yyyy-MM-dd").parse(new SimpleDateFormat("yyyy-MM-dd").format(new Date()))));
                ...
                if (!normalclassshedules.isEmpty()) {
                    for (Normalclassshedule normalclassshedule : normalclassshedules) {
                        ...
                        jSONObject.put("day", sdfday.format(normalclassshedule.getDate()));
                        jSONObject.put("month", sdfmon.format(normalclassshedule.getDate()));
                        jSONObject.put("starttime", sdftime.format(normalclassshedule.getStarttime()));
                        jSONObject.put("endtime", sdftime.format(normalclassshedule.getEndtime()));
                        jSONObject.put("description", normalclassshedule.getSubjectvisebatch().getSubject().getSubject());
