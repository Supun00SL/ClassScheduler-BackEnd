 ...
 */
@WebServlet(name = "checknoti", urlPatterns = {"/checknoti"})
public class checknoti extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Set<pojos.Specialnotifications> specialnotificationses = student.getSpecialnotificationses();

            JSONArray jSONArray = new JSONArray();
            for (Specialnotifications specialnotifications : specialnotificationses) {
                if (specialnotifications.getState().equals("new")) {
                    JSONObject jsono = new JSONObject();
                    jsono.put("Header", specialnotifications.getHeader());
                    jsono.put("Description", specialnotifications.getDescription());
                    jSONArray.add(jsono);
                }
            }
